...
router
  .route("/")
  .get(async (req, res) => await archiveService.findAll())
  .post(async (req, res) => await archiveService.create(req.body))

router
  .route("/id/:id")
  .get(async (req, res) => await findById(req, res))
  .put(async (req, res) => await archiveService.update(req.body))
  .delete(async (req, res) => await archiveService.remove(req.body))
